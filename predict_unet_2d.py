# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 14:19:25 2024
...
direktori_prediksi_ed = "D:/Intelligent Multimedia Network/Research/Riset Bu Dini/Dataset/acdc17/acdc17/Data 2D/ED/Hasil Predict 2D versi 3/unet/msefocalctc/"
...
def membuat_direktori_2d_ed_prediksi(id_pasien, path_direktori):
    ...
    direktori_rv = os.path.join(direktori_pasien, "prediksi right ventricle")
    direktori_myo = os.path.join(direktori_pasien, "prediksi myocardium")
    direktori_lv = os.path.join(direktori_pasien, "prediksi left ventricle")
...
def main():
    ...
    model = load_model('D:/Intelligent Multimedia Network/Research/Riset Bu Dini/Dataset/acdc17/acdc17/Data 2D/ED/Hasil Predict 2D versi 3/model/model unet epoch 50/model_unet_cardiac_ed_batch8_msefocalcrossloss_1e-3.hdf5', compile=False)
